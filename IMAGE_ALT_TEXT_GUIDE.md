...
**Purpose:** This guide ensures all images added to the portfolio site are
optimized for search engines and accessible to screen reader users.
...
4. **Image Search:** Well-written alt text helps images rank in Google Image
   Search
...
<img
  ...
  alt="This is a photograph taken at the NJIT EverydayAI community event on November 5th, 2025, where the Director of Enterprise AI at NJIT presented to Newark residents about how to use AI tools in their daily lives for health, education, legal help, and productivity purposes."
/>
```
...
**Key Principle:** Describe what's relevant to the surrounding content, not just
what you see.
...
3. ❌ Writing for SEO only, not users:
   `alt="AI machine learning artificial intelligence"`
...
**Remember:** Good alt text serves both humans and search engines. When in
doubt, prioritize clarity and usefulness for screen reader users.
